...
class RegisteredDrive: Drive {
    ...
    init(initialCoordinates: CLLocationCoordinate2D, finalCoordinates: CLLocationCoordinate2D, initialDate: Date, finalDate: Date, moneySpent: Double, ticketNumber: String, notes: String) {
    ...
    init(from drive: Drive, moneySpent: Double, ticketNumber: String, notes: String) {
